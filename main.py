...
def main():
        process_test_url(testurl,'test_features.csv')
        flask_print = tr.gui_caller('url_features.csv','test_features.csv')      #testing with urls in query.txt
        print flask_print
        return flask_print
